                        ...
                        <form method="POST" action="{{URL::to('/dang-ki-uv')}}" id="signup-form" class="signup-form" style="height:auto">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-input" name="user_hoten" id="first_name" require />
                                </div>
                                <div class="form-group">
                                    <label for="last_name">Username</label>
                                    <input type="text" class="form-input" name="user_taikhoan" id="last_name" require />
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-input" name="user_mk" id="password" require />
                                </div>
                                <div class="form-group">
                                    <label for="re_password">Nhập lại mật khẩu</label>
                                    <input type="password" class="form-input" name="user_re_mk" id="re_password" require />
                                </div>
                            </div>
                            <!-- <div class="form-text">
