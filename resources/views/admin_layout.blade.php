...
<script src="{{asset('public/backend/js/morris.j')}}s"></script>
</head>
<body>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="{{URL :: to('/admin-layout')}}">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="typography.html">Xóa hồ sơ</a></li>
						<li><a href="glyphicon.html">Liệt kê hồ sơ</a></li>
