                    ...
                    <aside class="col-md-4">
                        <div class="careerfy-right">
                            <ul class="careerfy-user-section">
                                <li><a class="careerfy-color careerfy-open-signin-tab" href="{{URL:: to('/user-dangky')}}">ĐĂNG KÝ</a></li>
                                <li><a class="careerfy-color careerfy-open-signup-tab" href="{{URL :: to('/dang-nhap')}}">ĐĂNG NHẬP</a></li>
                            </ul>
            ...
            <div class="careerfy-banner-caption">
                <div class="container">
                    ...
                    <form class="careerfy-banner-search">
                        <ul>
                            <li>
                                <input value="Nhập tên công việc cần tìm" onblur="if(this.value == '') { this.value ='Nhập tên công việc cần tìm'; }" onfocus="if(this.value =='Nhập tên công việc cần tìm') { this.value = ''; }" type="text">
                            </li>
                            <li>
